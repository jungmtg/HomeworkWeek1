namespace HomeworkWeek1.Models
{
	public static class RepositoryHelper
	{
		...
		public static 客戶名稱聯絡人數量銀行帳戶數量Repository Get客戶名稱聯絡人數量銀行帳戶數量Repository()
		{
			var repository = new 客戶名稱聯絡人數量銀行帳戶數量Repository();
			repository.UnitOfWork = GetUnitOfWork();
			return repository;
		}

		public static 客戶名稱聯絡人數量銀行帳戶數量Repository Get客戶名稱聯絡人數量銀行帳戶數量Repository(IUnitOfWork unitOfWork)
		{
			var repository = new 客戶名稱聯絡人數量銀行帳戶數量Repository();
			repository.UnitOfWork = unitOfWork;
			return repository;
